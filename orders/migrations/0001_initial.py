    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_unit', orders.models.LowerCase(blank=True, default='kg', max_length=30, null=True)),
                ('item_qty', models.DecimalField(decimal_places=1, default=0, max_digits=7)),
                ('packing_type', orders.models.LowerCase(blank=True, default='cr', max_length=30, null=True)),
                ('order_type', orders.models.LowerCase(blank=True, default='or', max_length=30, null=True)),
                ('item_order_status_id', models.PositiveBigIntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_order_trn_id', models.PositiveBigIntegerField(blank=True, default=0, null=True)),
