...
function alertmsg(msg, duration) {
  ...
  msgdiv.setAttribute(
    "style",
    "   z-index: 999998; top:0;  left:0; right:0; bottom:0; position:absolute; padding:10px; background-color: rgba(0,0,0,0.1); text-align: center;"
  );
...
function CustomPrompt() {
  this.render = function (header, dialog, fctn) {
    ...
    d_header_h.style =
      "position: relative; font-weight: bold; margin:0; top: 25%; -ms-transform: translateY(-50%);transform: translateY(-50%);";
    ...
    inputdialog.setAttribute(
      "style",
      "border:1px solid black; font-size:18px; height:30px; border-radius:7px; width:100%;"
    );
...
function CustomAlert() {
  this.render = function (header, dialog, duration) {
    ...
    d_footer.className = "base-modal-footer col-l-12 col-m-12 col-s-12";
    d_footer.innerHTML =
      '<button style="float:right; margin-top:5px; margin-right:10px;" class="buttonstyle" onclick="c_alert.ok()">Ok</button>';
    cont_id.appendChild(d_footer);
...
function c_confirm(header, dialog) {
  return new Promise(function (resolve) {
    ...
    d_footer.className = "base-modal-footer col-l-12 col-m-12 col-s-12";
    d_footer.innerHTML =
      '<button class="buttonstyle" id="true_btn" style="float:right; margin-top:5px; margin-right:10px;">OK</button> <button id="false_btn"; style="float:right; margin-top:5px; margin-right:10px;" class="buttonstyle" >Cancel</button>';
    cont_id.appendChild(d_footer);
